...
internal static class ResolveHubAssistantKnowledge
{
    ...
    internal const string TicketCreationRolesAnswer =
        "Only Employees and Admins  can create tickets in ResolveHub.";
    ...
    internal const string RolesAndNavigation = """
        ...
        Admin: view organizational tickets; directly assign/reassign eligible tickets; approve/reject Manager assignment requests; review/mark duplicates; filter/export reports; manage users and categories; view Team Workload, notifications, and audit log; comment publicly. Cannot create tickets. Admin cannot view Private comments unless independently the assigned Agent.
        Exact navigation:
        ...
        Admin: Dashboard, All Tickets, Ticket Assignments, Team Workload, Users, Categories, System Audit Log, Notifications; Profile through account menu.
        """;

    internal const string Creation = "Only Employees can create tickets; IT Support Agents, Managers, and Admins cannot. For an unauthorized role, stop after denying creation permission and do not provide categories, fields, attachments, or creation steps. For an authorized Employee: fields are Title, Description, Category, Priority, and optional Attachments; actions are Analyze with AI, Apply Suggestions, Save as Draft, Cancel, and Submit Ticket. Submission creates an Open ticket owned by the authenticated creator. Do not describe Report an Issue, Request a Service, or Request IT Support as controls or ticket types.";
    ...
    internal const string AiFeatures = """
        ...
        """;
    internal const string Troubleshooting = "For general IT questions, give 3-6 low-risk practical steps using tentative language such as Try; never claim a definite diagnosis, device access, or completed actions, expose credentials, disable security, or recommend destructive actions. If basic steps fail, suggest the user's permitted ResolveHub path; do not tell IT Support Agents, Managers, or Admins to create tickets. Recommend only confirmed categories/priorities when useful.";
